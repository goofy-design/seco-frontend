...
// Mock available statuses from API
    ...
    <div className="relative static">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute z-50 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg right-0 top-full">
...
const Participants = () => {
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      await axiosInstance.patch(`/event-applications/${participantId}/status`, {
        status: newStatus,
      });
  ...
  const handleAddCustomStatus = (newStatus: string) => {
